...
describe('MovieController', () => {
  ...
  describe('getMovies', () => {
    it('should call movieService.findAll with the correct parameters', async () => {
      ...
      const res = await movieController.getMovies(dto as any, userId);
  ...
  describe('getMovie', () => {
    it('should call movieService.findOne with correct id', async () => {
      const id = 1;
  ...
  describe('postMovie', () => {
    it('should call movieService.create with the correct parameters', async () => {
      ...
      await movieController.postMoive(
    ...
    describe('patchMovie', () => {
      it('should call movieService.update with the correct parameters', async () => {
        const id = 1;
        const body: UpdateMovieDto = { title: 'test2' };
